...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Affordable thermal backup power bricks for homes, backrooms and small businesses, with live area outage tracking and instant quotations." },
    ],
    links: [
